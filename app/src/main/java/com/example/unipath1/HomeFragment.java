...
public class HomeFragment extends Fragment {
                              ...
                              Bundle savedInstanceState)
    {
        ...
        student_id_static= Integer.parseInt(student_id);
        ...
        int number_of_completed_subjects =dataBaseHelper.get_number_of_completed_subjects(current_semester, Integer.parseInt(student_id));
        int number_in_progress_subjects =dataBaseHelper.get_number_in_progress_subjects(current_semester, Integer.parseInt(student_id));

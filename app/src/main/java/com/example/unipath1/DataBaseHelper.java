...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public int get_number_of_completed_subjects(int semester_id ,int student_id){
    ...
    public int get_number_in_progress_subjects(int semester_id ,int student_id){
        String queryString = "SELECT count(*) FROM studies JOIN Subject on Subject.subject_id = studies.subject_id where semester_id = " +semester_id + " and student_id = " +student_id + ";";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(queryString, null);
        int subjects_number =0;
    ...
    public ArrayList<Professor> get_top_profs(){
        int n=0;
    ...
    public boolean allow_to_rate(int stud_id,int prof_id,int subject_id){
